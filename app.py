...
@app.route("/getPlotCSV/<date>")
def getPlotCSV(date):
    csv = 'Date,Username,ADGroup,Time\n'
    ...
    try:
        ...
        headers={"Content-disposition":
                 "attachment; filename=ise_radius_report.csv"})
    ...
    for i in temp:
        ...
        if config.faculty_sid in str(i['adgroup']):
            csv = csv + i['date'] + ',' + i['username'] + ',' + "Faculty" + ',' + i['time'] + '\n'

        if config.student_sid in str(i['adgroup']):
            csv = csv + i['date'] + ',' + i['username'] + ',' + "Student" + ',' + i['time'] + '\n'

        if config.faculty_sid in str(i['adgroup']) and config.student_sid in str(i['adgroup']):
            csv = csv + i['date'] + ',' + i['username'] + ',' + "Faculty/Student" + ',' + i['time'] + '\n'
